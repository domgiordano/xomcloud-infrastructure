...
resource "aws_api_gateway_deployment" "api_deploy" {
 ...
 lifecycle {
  ...
  depends_on = [
    ...
    module.post_download_tracks_endpoint
  ]
}
...
module "post_download_tracks_endpoint" {
  ...
  rest_api_id             = aws_api_gateway_rest_api.api_gateway.id
  parent_resource_id      = aws_api_gateway_resource.download_resource.id
  ...
  uri                     = aws_lambda_function.download_tracks.invoke_arn
...
resource "aws_lambda_permission" "download_tracks_post_permission"{
